  ...
  return <section id="projects" className="min-h-screen flex items-center py-20">
      <div className="container mx-auto px-6">
          ...
          >
              ...
              <div className="md:w-2/3">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className={`text-xs px-2 py-1 rounded ${project.status === 'Live' ? 'bg-terminal-green/20 text-terminal-green' : project.status === 'In Development' ? 'bg-terminal-cyan/20 text-terminal-cyan' : 'bg-terminal-magenta/20 text-terminal-magenta'}`}>
                    {project.status}
                  </div>
                </div>
                ...
                <div className="font-mono">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="ml-4 space-y-1">
                      {project.tech.map((tech, idx) => <div key={idx} className="text-xs">
        ...
        <div className="text-center mt-12">
          <a href="https://github.com/its-usif" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 text-terminal-gray hover:text-terminal-green transition-colors duration-300 font-mono hover-glow px-6 py-3 border border-terminal-gray/30 hover:border-terminal-green/50 rounded">
